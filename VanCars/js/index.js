$(document).ready(function(){
  ...
  FJS.addCriteria({ field: 'EngineCapacity', ele: '#rating_filter', type: 'range' });
  FJS.addCriteria({field: 'price', ele: '#runtime_filter', type: 'range' });
  FJS.addCriteria({field: 'CompanyId', ele: '#genre_criteria input:checkbox' });
